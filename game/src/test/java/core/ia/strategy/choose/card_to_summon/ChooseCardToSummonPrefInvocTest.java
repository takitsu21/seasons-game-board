...
class ChooseCardToSummonPrefInvocTest {
    private Config config = new Config();
    private GameController controller = new GameController();
    private Board board;
    private FacadeIA facadeIA;
    private ChooseCardToSummonPrefInvoc chooseCardToSummonPrefInvoc;
    ...
    void setUp() {
        ...
        chooseCardToSummonPrefInvoc = new ChooseCardToSummonPrefInvoc();
        player.setChooseCardToSummon(chooseCardToSummonPrefInvoc);
    ...
    void chooseEqual() {
        ...
        assertEquals(card1, chooseCardToSummonPrefInvoc.choose(player));
    }
