...
class ChooseCardForInitHandPrefInvocationTest {
    private final Config config = new Config();
    private final GameController controller = new GameController();
    private final Board board = controller.getBoard();
    private FacadeIA facadeIA;
    private ChooseCardForInitHandPrefInvocation chooseCardForInitHandPrefInvocation;
    ...
    void setUp() {
        ...
        chooseCardForInitHandPrefInvocation = new ChooseCardForInitHandPrefInvocation();
    ...
    void choose() {
        ...
        res = new ArrayList<>(List.of(card9, card8, card6, card7, card5, card1, card2, card3, card4));
        ...
        assertTrue(equal(cards, chooseCardForInitHandPrefInvocation.choose(player, listCards, config)));
    }
