...
public class ChooseCardComeBackInHandPrefCardPointsTest {
    private Config config = new Config();
    private GameController controller = new GameController();
    private Board board;
    private FacadeIA facadeIA;
    private ChooseCardComeBackInHandCardPoints chooseCardComeBackInHandCardPoints;
    ...
    void setUp() {
        ...
        chooseCardComeBackInHandCardPoints = new ChooseCardComeBackInHandCardPoints();
        deck = new Deck();
        card1 = deck.findCard(7);
        card2 = deck.findCard(16);
        card3 = deck.findCard(22);
    ...
    void chooseEqual() {
        ...
        assertEquals(card1, chooseCardComeBackInHandCardPoints.choose(player));
    }
}
