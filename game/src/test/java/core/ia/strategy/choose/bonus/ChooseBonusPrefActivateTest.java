...
public class ChooseBonusPrefActivateTest {
    private Config config = new Config();
    private GameController controller = new GameController();
    private ChooseBonusPrefActivate chooseBonusPrefActivate = new ChooseBonusPrefActivate();
    ...
    void chooseTest() {
        ...
        BonusType bonus = chooseBonusPrefActivate.choose(player);
        assertEquals(BonusType.CHANGE_ENERGY, bonus);          // Choose Crystallize if Crystallize in the list
    }
}
