...
public class ChooseCardToDeletePrefCardPointsTest {
    private Config config = new Config();
    private GameController controller = new GameController();
    private Board board;
    private FacadeIA facadeIA;
    private ChooseCardToDeletePrefCardPoints chooseCardToDeletePrefCardPoints;
    ...
    void setUp() {
        ...
        chooseCardToDeletePrefCardPoints = new ChooseCardToDeletePrefCardPoints();
        deck = new Deck();
    ...
    void choose() {
        ...
        assertEquals(card3, chooseCardToDeletePrefCardPoints.choose(player));
    }
