...
public class ChoosePlayerEnergyToCopyPrefInvocTest {
    private final Config config = new Config();
    private final GameController controller = new GameController();
    private Board board;
    private Deck deck;
    private ChoosePlayerEnergyToCopyPrefInvoc choosePlayerEnergyToCopy;
    ...
    void setUp() {
        ...
        choosePlayerEnergyToCopy = new ChoosePlayerEnergyToCopyPrefInvoc();
