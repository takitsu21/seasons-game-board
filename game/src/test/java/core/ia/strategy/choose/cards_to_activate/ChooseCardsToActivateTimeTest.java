...
public class ChooseCardsToActivateTimeTest {
    private FacadeIA facadeIA;
    private ChooseCardsToActivateTime chooseCardsToActivate;
    private Player player;


    @BeforeEach
    void setUp() {
        chooseCardsToActivate = new ChooseCardsToActivateTime();
    ...
    @Test
    void chooseWithBottesTemporelles() {
        ...
        assertEquals(BottesTemporelles.class, chooseCardsToActivate.choose(player).getClass());
    }
