...
class ChooseCardToSummonTimeTest {
    private Config config = new Config();
    private GameController controller = new GameController();
    private Board board;
    private FacadeIA facadeIA;
    private ChooseCardToSummonTime chooseCardToSummon;
    ...
    void setUp() {
        ...
        chooseCardToSummon = new ChooseCardToSummonTime();
        player.setChooseCardToSummon(chooseCardToSummon);
