...
public class ChoosePlayerEnergyToCopyComboTest {
    private final Config config = new Config();
    private final GameController controller = new GameController();
    private Board board;
    private Deck deck;
    private ChoosePlayerEnergyToCopyCombos choosePlayerEnergyToCopyCombos;
    ...
    void setUp() {
        ...
        choosePlayerEnergyToCopyCombos = new ChoosePlayerEnergyToCopyCombos();
        ...
        Card card = deck.findCard(7);
        Card card2 = deck.findCard(17);
        Card card3 = deck.findCard(13);
        Card card4 = deck.findCard(18);
        Card card5 = deck.findCard(15);

        board.initHand(player);
        inventory.getHand().setCardsInHand(new ArrayList<>(List.of(card, card2, card3, card4, card5)));
    }

    @Test
    void choose() {
        assertEquals(player2, choosePlayerEnergyToCopyCombos.choose(player));
    }
}
