...
//        playerList[1] = playerFactory.getPlayer(TypeAIPlayer.MONTECARLO, "2");
//        playerList[2] = playerFactory.getPlayer(TypeAIPlayer.COMPOSE_MARG, "3");
//        playerList[3] = playerFactory.getPlayer(TypeAIPlayer.PREF_CARD_POINTS, "4");
        return playerList;
    }
